...
pub fn render_frame(
    ...
    #[cfg(feature = "text")] mut text_layout_cache: ResMut<crate::integrations::text::layout_cache::TextLayoutCache>,
...
pub fn detect_vello_scene_changes(
    ...
    #[cfg(feature = "lottie")]
    (changed_world_lottie, changed_ui_lottie, changed_playhead, mut lottie_events, mut removed_lottie, mut removed_ui_lottie): (
        Query<
            (),
            (
